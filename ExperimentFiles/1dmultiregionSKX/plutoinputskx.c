...
for (t = 0; t <T; t++) {
    for (i =0; i <N; i++) {
        A[1][i] = (i < N/2) ? (0.25*((i == N-1)? 0 :A[0][i+1]) + 0.5*A[0][i] + 0.25*((i == 0)? 0 :A[0][i-1])) : (0.2*((i == N-1)? 0 :A[0][i+1]) + 0.6*A[0][i] + 0.2*((i == 0)? 0 :A[0][i-1]));
    }
    for (i =0; i <N; i++) {
        A[0][i] = (i < N/2) ? (0.25*((i == N-1)? 0 :A[1][i+1]) + 0.5*A[1][i] + 0.25*((i == 0)? 0 :A[1][i-1])) : (0.2*((i == N-1)? 0 :A[1][i+1]) + 0.6*A[1][i] + 0.2*((i == 0)? 0 :A[1][i-1]));
