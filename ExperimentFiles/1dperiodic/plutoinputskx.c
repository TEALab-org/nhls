...
#pragma scop
    for (t = 0; t <T; t++) {
        for (i =0; i <N; i++) {
            A[1][i] = (pow(exp(1),-0.01*t)/2)*((i == N-1)?A[0][0]:A[0][i+1]) + (1-pow(exp(1),-0.01*t))*A[0][i] + (pow(exp(1),-0.01*t)/2)*((i == 0)?A[1][N-1]:A[0][i-1]);
        }
        for (i =0; i <N; i++) {
            A[0][i] = (pow(exp(1),-0.01*t)/2)*((i == N-1)?A[1][0]:A[1][i+1]) + (1-pow(exp(1),-0.01*t))*A[1][i] + (pow(exp(1),-0.01*t)/2)*((i == 0)?A[1][N-1]:A[1][i-1]);
        }
    }
#pragma endscop
