...
pub struct TVAPAccountBuilder<'a, const GRID_DIMENSION: usize> {
    plan: &'a APPlan<GRID_DIMENSION>,
}

impl<'a, const GRID_DIMENSION: usize> TVAPAccountBuilder<'a, GRID_DIMENSION> {
    ...
    pub fn node_requirements(plan: &'a APPlan<GRID_DIMENSION>) -> Vec<usize> {
        ...
        let account_builder = TVAPAccountBuilder { plan };
    ...
    fn handle_periodic_node(
        ...
        let mut node_requirement = remainder.max(2 * complex);
